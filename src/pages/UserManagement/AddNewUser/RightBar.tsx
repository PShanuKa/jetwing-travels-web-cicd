        ...
        <div className="flex flex-col gap-5 px-[50px] flex-1">
          ...
          <div className="w-full">
            <div className="w-full h-[70px] rounded-[10px] flex items-center gap-3 px-4 ">
              <div>
                <img src="https://res.cloudinary.com/dldtrjalo/image/upload/v1732767281/oav7dzuhqxvouhciglcd.jpg" alt="" className="w-[50px] h-[50px] rounded-full object-cover" />
            </div>
          ...
          <div className="w-full pl-5">
            <div className="flex items-center gap-5 ">
              ...
              <div>
                <p className="text-[14px] text-[#101928] font-medium">Admin</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full pl-5">
            <div className="flex items-center gap-5 ">
              <div className="w-[24px] h-[24px] flex items-center justify-center">
                <HiOutlineBuildingOffice2 className="text-[var(--iconGray)]" size={20} />
              </div>
              <div>
                <p className="text-[14px] text-[#101928] font-medium">Jetwing Travels</p>
                <p className="text-[14px] text-[#101928] font-medium">Jetwing Eco Holidays</p>
                <p className="text-[14px] text-[#101928] font-medium">Jetwing Adventure</p>
              </div>
            </div>
          </div>
